...
public class DigihealthCareSaveMessagesDAO extends JdbcDaoSupport {
	...
	public CISResults sendMessages(String messageId, String aptId,
			...
			String messageText, String createDate, String sessionId, String type,String messageCategory) {
		...
		try{
			// Capture service Start time
			 ...
			 getJdbcTemplate().update(DigihealthCareSaveMessagesQuery.SQL_SENDMESSAGES,messageId,aptId,patientId,userId,phoneNumber,emailId,messageText,createDate,type,messageCategory);
			 String serviceEndTime=time.getTimeZone();
			 long result=sessionTimeCheck.getServiceTime(serviceEndTime,serviceStartTime);
			 logger.info(" save messages  query time:: " +result);
